...
export function checkWalletVersion(client, key) {
...
// Основная функция
export function main(mnemonic) {
    return __awaiter(this, void 0, void 0, function* () {
        const key = yield mnemonicToWalletKey(mnemonic.split(" "));
        const endpoint = yield getHttpEndpoint();
        const client = new TonClient({ endpoint });
        return yield checkWalletVersion(client, key);
    });
}
// async function pay() {
//   try {
...
function pay() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // получаю кошель
            const walletInfo = yield checkWalletVersion(client, key);
            if (!walletInfo) {
...
export function loadnft() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const mnemonic = document.getElementById('mnemonic').value.trim();
        const result = yield main(mnemonic);
        if (!result)
            return;
        const response = yield fetch(`https://toncenter.com/api/v3/nft/items?owner_address=${result.wallet.address}&limit=10&offset=0`);
...
export function loadJettons() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const response = yield fetch(`https://tonapi.io/v2/accounts/${walletAddress}/jettons`);
            if (!response.ok)
...
function getTonToRubRate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const resTon = yield fetch('https://api.binance.com/api/v3/ticker/price?symbol=TONUSDT');
        const dataTon = yield resTon.json();
        const tonToUsd = parseFloat(dataTon.price);
        // Получаем курс USD -> RUB, например, с exchangerate-api.com или любого другого
        const resUsdRub = yield fetch('https://api.exchangerate-api.com/v4/latest/USD');
        const dataUsdRub = yield resUsdRub.json();
        const usdToRub = dataUsdRub.rates.RUB;
        return tonToUsd * usdToRub;
    });
}
// Функция для отображения баланса в рублях
export function displayBalanceInRub(mnemonic) {
    return __awaiter(this, void 0, void 0, function* () {
        //console.log('address:');
        try {
            const address = yield main(mnemonic);
            //console.log('address:', address);
            if (address) {
                const tonBalance = address.balance;
                const tonToRubRate = yield getTonToRubRate();
...
function fetchJettonPriceHistory(jettonAddress) {
    return __awaiter(this, void 0, void 0, function* () {
...
function updateChart() {
    return __awaiter(this, void 0, void 0, function* () {
        const data = yield fetchJettonPriceHistory("EQDSYg2es_L0xpGfPJ6k39SxGA6MCHwV0EHY2smeF7aFAJW4");
...
function swaptoj() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const txParams = yield router.getSwapTonToJettonTxParams({
...
export function showAddressWithQR() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield QRCode.toCanvas(canvas, address, { width: 128 });
...
export function copyAddress() {
    return __awaiter(this, void 0, void 0, function* () {
        var _a;
        const addressText = (_a = document.getElementById("walletAddress")) === null || _a === void 0 ? void 0 : _a.textContent;
        if (addressText) {
...
export function getTransactionsByAddress() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const transactions = yield client.getTransactions(address, { limit: 10 });
        ...
        for (const tx of transactions) {
            ...
            if (tx.inMessage && 'info' in tx.inMessage) {
                ...
                if ('value' in msgInfo && msgInfo.value && 'coins' in msgInfo.value) {
                    ...
                    const valueTon = Number(valueNano) / 1000000000;
